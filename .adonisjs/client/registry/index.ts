...
const routes = {
  ...
  'admin.siteSettings.index': {
    ...
    tokens: [{"old":"/admin/site-settings","type":0,"val":"admin","end":""},{"old":"/admin/site-settings","type":0,"val":"site-settings","end":""}],
    types: placeholder as Registry['admin.siteSettings.index']['types'],
  },
  'admin.siteSettings.updateLogo': {
    methods: ["POST"],
    pattern: '/admin/site-settings/logo',
    tokens: [{"old":"/admin/site-settings/logo","type":0,"val":"admin","end":""},{"old":"/admin/site-settings/logo","type":0,"val":"site-settings","end":""},{"old":"/admin/site-settings/logo","type":0,"val":"logo","end":""}],
  ...
  'admin.siteSettings.updateSubtitle': {
    ...
    tokens: [{"old":"/admin/site-settings/subtitle","type":0,"val":"admin","end":""},{"old":"/admin/site-settings/subtitle","type":0,"val":"site-settings","end":""},{"old":"/admin/site-settings/subtitle","type":0,"val":"subtitle","end":""}],
